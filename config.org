...
(use-package eglot
  ...
  :commands (eglot-ensure
             ...
             eglot-format-buffer))
#+END_SRC
**** TODO MOVE TO PYTHON pylsp setup
#+BEGIN_SRC emacs-lisp :tangle post-init.el
...
#+END_SRC
** Text
*** TODO Move Write-good-mode to code-augmentation
...
#+END_SRC
*** TODO Dictionary: Currently waiting on a solution to https://github.com/jamescherti/quick-sdcv.el/issues/3
#+BEGIN_SRC emacs-lisp :tangle post-init.el
...
*** Citations
#+BEGIN_SRC emacs-lisp :tangle post-init.el
(use-package papis :ensure (:host github :repo "papis/papis.el"))
#+END_SRC
*** Annotation
#+BEGIN_SRC emacs-lisp :tangle post-init.el
