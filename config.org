...
* TODO Introduction Transclude README.md
...
(when (< emacs-major-version 29)
  (error "Only verified to run on Emacs 29 and newer; you have version %s" emacs-major-version))
#+END_SRC
** Basic config
#+BEGIN_SRC emacs-lisp :tangle pre-early-init.el
...
#+END_SRC
*** TODO Split and change to corfu [[https://github.com/manateelazycat/lsp-bridge?tab=readme-ov-file][lsp-bridge + yasnippet]]
...
;; Make sure to have the following packages installed to your python env:
...
;; Make sure that lsp-bridge still works in tty on all platforms
...
#+END_SRC
* Hyperbole
Clickable hypermedia links + hyrolo CRM
#+BEGIN_SRC emacs-lisp :tangle post-init.el
