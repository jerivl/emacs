...
;; * Editing niceities
;; Allow emacs to use pbcopy for the system clipboard
(use-package pbcopy
  :ensure t
  :config
  (turn-on-pbcopy))
...
*** TODO Split: [[https://github.com/jamescherti/minimal-emacs.d?tab=readme-ov-file#enhancing-the-elisp-development-experience][Enhancing the Elisp development experience]]
#+BEGIN_SRC emacs-lisp :tangle post-init.el
...
* Major modes
** Python
** [[https://github.com/haskell/haskell-mode/tree/bd89438b0e6e6b6877d635699e265da85e85ca06][Haskell]]
#+BEGIN_SRC emacs-lisp :tangle post-init.el
  (use-package haskell-mode :ensure t )
#+END_SRC

** HTML/CSS
*** [[https://github.com/fxbois/web-mode/tree/master][web-mode + astro + svelte]]
#+BEGIN_SRC emacs-lisp :tangle post-init.el
...
*** TODO [[https://github.com/P233/postcss-sorting.el/tree/deb0c935d2904c11a965758a9aee5a0e905f21fc][postcss-sorting]]
...
#+END_SRC
*** Dictionary
TODO Currently waiting on a solution to https://github.com/jamescherti/quick-sdcv.el/issues/3
#+BEGIN_SRC emacs-lisp :tangle post-init.el
...
#+BEGIN_SRC emacs-lisp :tangle post-init.el
(use-package papis
  :ensure (:host github :repo "papis/papis.el"))
#+END_SRC
* Calendar

* Homw
I'm primarily using org mode for all of my notes. The only exception is the foss software db that I generate into markdown. (Maybe I'll publish it eventually)
#+BEGIN_SRC emacs-lisp :tangle post-init.el
(use-package howm
  :ensure t
  :init
  ...
  ;;
  ;; Preferences
  (setq howm-directory "/Users/jer/Library/CloudStorage/ProtonDrive-jerivl@pm.me-folder/org/howm") ;; Where to store the files?
...
* Email
** Himalaya
I use himalaya primarily because it allows me to reference any email with a one line cmd
+BEGIN_SRC emacs-lisp :tangle post-init.el
